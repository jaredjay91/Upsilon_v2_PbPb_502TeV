...
then
  ...
  root -b -q -l "CheckFitExists.C($collId,$ptLow,$ptHigh,$yLow,$yHigh,$cLow,$cHigh,$muPtCut,$dphiEp2Low,$dphiEp2High,$whichSyst,$whichRound)" >> junk$whichRound
  isIt=$(tail -c 2 junk$whichRound)
  rm junk$whichRound
else
  isIt=1
fi
...
then
  ...
  root -b -q -l "CheckFitQuality.C($collId,$ptLow,$ptHigh,$yLow,$yHigh,$cLow,$cHigh,$muPtCut,$dphiEp2Low,$dphiEp2High,$whichSyst,$whichRound)" >> junk$whichRound
  ToF=$(tail -c 2 junk$whichRound)
  rm junk$whichRound
else
