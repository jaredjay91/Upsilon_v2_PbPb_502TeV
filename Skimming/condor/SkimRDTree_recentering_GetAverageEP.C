...
void SkimRDTree_recentering_GetAverageEP(int nevt=1000, int dateStr=20201109) 
{
...
//  mytree->SetBranchAddress("rpAng", rpAng, &b_rpAng);
  ...
  TFile* newfile;
  newfile = new TFile(Form("skims/newOniaTree_Skim_UpsTrig_MC_RECENTERED_n%i_%i.root",nevt,dateStr),"recreate");
